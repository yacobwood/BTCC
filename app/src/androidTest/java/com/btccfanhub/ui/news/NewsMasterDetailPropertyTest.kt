 ...
 *
 * Property 1: For any master-detail screen (News) rendered at a screen width
 ...
 */
class NewsMasterDetailPropertyTest {
    ...
    fun masterDetailLayoutStructureOnTablet() {
        ...
        runBlocking {
            checkAll(PropTestConfig(iterations = 100), Arb.int(600..1200)) { width ->
                ...
                // Placeholder text visible when no article selected
                rule.onNodeWithText("Select an article to read")
                    .assertIsDisplayed()
            }
        }
    }
