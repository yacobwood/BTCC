...
/** Final 2014 BTCC standings — Drivers' Championship per Wikipedia. */
object Standings2014 {
    ...
    val drivers: List<DriverStanding> = listOf(
        ...
        DriverStanding(position =  7, name = "Sam Tordoff",        team = "Honda Yuasa Racing", car = "88",  points = 255, wins = 1),
        ...
        DriverStanding(position = 21, name = "Warren Scott",       team = "CHROME Edition Restart Racing", car = "39",  points = 18,  wins = 0),
